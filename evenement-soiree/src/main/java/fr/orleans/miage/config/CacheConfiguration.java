package fr.orleans.miage.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("evenementSoiree");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("evenementSoiree");
        ...
        config.getMapConfigs().put("fr.orleans.miage.domain.*", initializeDomainMapConfig(jHipsterProperties));
