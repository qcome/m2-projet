...
import { UserEventComponent } from 'app/entities/userEvent/user-event/user-event.component';
...
describe('Component Tests', () => {
    describe('UserEvent Management Component', () => {
        let comp: UserEventComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(UserEventComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.userEvents[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
